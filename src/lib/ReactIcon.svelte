<svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
	><path d="M14.5 7.584c0 1.657-3.134 3-7 3s-7-1.343-7-3 3.134-3 7-3 7 1.343 7 3z" stroke="currentColor" /><path
	...
	/><path
		...
		stroke="currentColor"
	/><path d="M6.5 7.584a1 1 0 102 0 1 1 0 00-2 0z" stroke="currentColor" /></svg
>
